...
export default function Home() {
  return (
    <div className='min-h-[80vh] flex flex-col justify-center items-center bg-gray-50 px-5 text-center'>
      ...
      <p className='text-lg md:text-2xl text-gray-600 max-w-2xl mb-8'>I am a Full-Stack Web Developer. I build modern solutions for your business using React, JavaScript and TailwindCSS.</p>
